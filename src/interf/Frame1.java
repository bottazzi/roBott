...
public void InitRobot() throws Exception
{
    ...
    this.carrega.CarregaArquivoCoordEntrada("C:\\Documents and Settings\\Vitor\\JDev\\jdev\\mywork\\Application1\\Project\\classes\\visu\\bracao.stl",  this.carrega.Componente);
...
//   sel.HashSetToArray(carga.pro_x);//newP);
   
//Retirado para que se insira a pea geometrica + os pontos sem redesenhar tudo

//  telaWorld.removeAll();//limpa a tela
//   sv.removeAll();  
//   sv = new SideCoordView(carga);//newP);
    
   //sv.NewSolid(carga.pro_x/*newP*/, false);
...
/*    
private void showCoord(Programa newProg) //throws Exception
{
   telaWorld.removeAll();//limpa a tela
   SideCoordView sv = new SideCoordView(newProg);//cria a tela
...
String filename = "";
      ...
      f.setDirectory("C:\\Testes\\ArquivosNeutros\\");
