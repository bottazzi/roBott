...
/*  public int num;
  ...
  public Float[][] coord_table = {{null,null,null}};
  public Coord_World WorkSpaceBounds; // Armazena o Offset(ponto de ref do Componente)
  public Coord_World RobotOffset; // Armazena o Offset(ponto de ref do Componente)
...
{
//    this.carrega.pro_x = this.carrega.CarregaArquivoCoordEntrada("C:\\Documents and Settings\\Vitor\\JDev\\jdev\\mywork\\Application1\\Project\\classes\\visu\\bracao.stl");
...
/**
 * Seta o nome identificador do Componente.
 * 
 * @param newId Recebe o nome identificador do Componente.
 * @return void
 * @see Componente
...
/**
 * Retorna um iterator para a Lista de Comandos  do Componente.
 * 
 * @param NoParameters
 ...
 */
/**
 * Retorna um iterator para a lista de vari veis dos comandos do Componente.
 * 
 * @param NoParameters
 * @return Retorna um apontador para cada objeto da lista de vari veis dos
 * comandos  do Componente.
 * @see java.util.Iterator
