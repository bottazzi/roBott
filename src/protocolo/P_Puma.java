...
public class P_Puma implements Protopon{

 final String movJ = "DO MOVE";
 final String movL = "DO MOVES";
 final String movC = "DO MOVE"; //para o manual fornecido n o foi encontrada refer ncia a mov circular, foi assumido o mov por junta.
